#include <stdio.h>
#include <graphics.h> // 调用图形库EasyX，安装教程在众号内，很简单
#include <conio.h>

#define PIC_HEIGHT 500 // 如修改图片请按图片像素修改
#define PIC_WIDTH 900  // 如修改图片请按图片像素修改
...
void main()
{
    ...
    SetWindowText(GetHWnd(), "水波纹效果（点击产生一个水波纹。移动鼠标连续产生水波纹）"); //设置窗口名
    loadimage(&src_img, "water.jpg");                                                     // 加载图片，大小：900*500，如修改图片，请按像素修改
